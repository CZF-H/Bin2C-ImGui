...
#define devicesButtonString "驱动器"
#define editPathButtonString "E"
#define searchString "搜索"
#define dirEntryString "[目录] "
#define linkEntryString "[链接] "
#define fileEntryString "[文件] "
#define fileNameString "文件名 : "
#define dirNameString "目录 :"
#define buttonResetSearchString "清除"
#define buttonDriveString "驱动器"
#define buttonEditPathString "编辑路径(或者右键目录按钮)"
#define buttonResetPathString "回滚至程序目录"
#define buttonCreateDirString "创建文件夹"
#define OverWriteDialogTitleString "文件已存在"
#define OverWriteDialogMessageString "你要覆盖这个文件吗？"
...
#define okCancelButtonAlignement 0.95f
...
#define tableHeaderDescendingIcon "v|"
#define tableHeaderFileNameString " 文件名"
#define tableHeaderFileTypeString " 文件类型"
#define tableHeaderFileSizeString " 大小"
#define tableHeaderFileDateString " 修改日期"
...
#define placesPaneWith 160.0f
// #define IMGUI_TOGGLE_BUTTON ImGui::Toggle
#define placesButtonString "位置"
#define placesButtonHelpString "位置"
#define addPlaceButtonString "+"
#define removePlaceButtonString "-"
#define validatePlaceButtonString "确定"
#define editPlaceButtonString "编辑"
...
#define placesDevicesGroupName "驱动器"
